...
<div align="center">
  ...
  ![Github Contributors](https://img.shields.io/github/contributors/No-Country/s13-03-m-node-react)
![Github Stars](https://img.shields.io/github/stars/No-Country/s13-03-m-node-react)
![Github Issues](https://img.shields.io/github/issues-raw/No-Country/s13-03-m-node-react)
![logo](/front/src/assets/images/Caratula_EduClass.webp)


  
</div>
<h2 align="start">EduClass</h2>
  ...
  Con EduClass, ofrecemos una herramienta de comunicación y seguimiento que brinda transparencia e inmediatez a los padres por parte de a institución escolar. El publico objetivo son instituciones y familias con hijos 
  escolarizados en instituciones educativas cuyas edades estén entre los 3 y 12 años (Jardín de Infantes/Infantil y Primaria).
    <br />
    <br />
...
<h2 align='start'>Funcionalidades - User stories:</h2>

<p align='start'>
  Como padre, quiero recibir notificaciones del colegio de mis hijos para poder estar informado sobre las actividades escolares y fechas importantes.

- Notificaciones generales de la institución.
- Notificaciones individuales de cada alumno.</p>
<p align='start'>Como padre, quiero poder ver las notas y progresos académicos de mi hijo en tiempo real para poder brindarle apoyo en sus estudios.

- Notas de boletines.
- Notas de profesor para refuerzos académicos.
- Métricas.</p>
<p align='start'>Como padre, quiero recibir notificaciones de la asistencia de mi hijo para asegurarme de que esté presente en clase y cumpliendo con sus obligaciones escolares.
...
- Métricas.</p>
<p align='start'>Como padre, quiero recibir notificaciones  de las salidas escolares y autorizarlas o rechazarlas.
...
<p align='start'>Como padre, quiero acceder al calendario escolar y a los horarios de clases de mis hijos para poder planificar con anticipación las actividades familiares. 
...
<p align='left'>Para utilizar la app como usuario (tutor responsable), previamente debe recibir un código del estudiante dado por la institución educativa. Con este código, podrá completar el formulario de registro.
</p> 
<p align='left'>Una vez creado el usuario, se validará los datos al mostrar la página de login donde se ingresará e-mail y contraseña.Ya logueado, se redirige a la pantalla de Home en el cual se presenta un banner con alguna fecha o evento importante de la institución. También están las tarjetas de Notificaciones, Actividad escolar, Calificaciones y Asistencias con las informaciones pertinentes de cada tema. Finalmente, en la parte inferior se encuentra un footer con los datos de contacto y redes sociales de la institución educativa.</p> 

<p align='left'>Nuestro objetivo es que cada pantalla sea práctica e intuitiva ya que se le ofrece al usuario diversas interacciones, como por ejemplo, autorizar o rechazar salidas, formularios de retiro y justificar inasistencias.
</p> 
...
<tr>
  ...
  <tr>
    <td>
      <div align="center">
        <a href="https://www.linkedin.com/in/juan-nebbia/" target="_blank" rel="author">
          <img width="110" src="https://avatars.githubusercontent.com/u/110181460?v=4"/>
        </a>
    ...
    <td>
      <div align="center">
        <a href="" target="_blank" rel="author">
          <img width="110" src="https://avatars.githubusercontent.com/u/22618545?v=4"/>
        </a>
    ...
    <td>
      <div align="center">
        <a href="" target="_blank" rel="author">
          <img width="110" src="https://avatars.githubusercontent.com/u/85122601?v=4"/>
        </a>
    ...
    <td>
      <div align="center">
        <a href="https://www.linkedin.com/in/paula-velez/" target="_blank" rel="author">
          <img width="110" src="https://media.licdn.com/dms/image/D4D03AQEJSeZUsugThQ/profile-displayphoto-shrink_800_800/0/1706310164105?e=1715212800&v=beta&t=CBbyDf-O1bnPrVxFi3v7X91sWPYe9kh9_HJM62IRi1w"/>
        </a>
    ...
    <td>
      <div align="center">
        <a href="https://www.linkedin.com/in/emanuel-ps/" target="_blank" rel="author">
          <img width="110" src="https://avatars.githubusercontent.com/u/101524982?v=4"/>
        </a>
    ...
    <td>
      <div align="center">
        <a href="https://www.linkedin.com/in/dalmiro-pintos/" target="_blank" rel="author">
          <img width="110" src="https://avatars.githubusercontent.com/u/122646774?v=4"/>
        </a>
        <a href="" target="_blank" rel="author">
...
<p align="center">
  <a  href="https://drive.google.com/file/d/1eKL1FhAuOmEK5E2t4rgkZqxcvEFsZmpX/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
  <img   src="./images/video.png"/></a></p>
...
<img src="./images/activitiesImages.png"/>

<img src="./images/authorization.png"/>

<img src="./images/attendances.png"/>

<img src="./images/attendancesForm.png"/>

<img src="./images/attendancesGraph.png"/>
